...
export class CompetenciaService {
  private apiUrl = 'http://146.190.137.83:5000/api/competencia'; 
  ...
  obtenerPDF(): Observable<Blob> {
    ...
    return this.http.get('http://146.190.137.83:5000/api/competencia/export-pdf', { headers: headers, responseType: 'blob' });
  }
